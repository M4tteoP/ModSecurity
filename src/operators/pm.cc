...
bool Pm::init(const std::string &file, std::string *error) {
    ...
    // Emulating PmFromFile logic, it bypasses Snort-Suricata format parsing. It permits the match of the '|' symbol for pipes
    // or the usage of the symbol itself as a separator
